...
-- A platform administrator can create a ready-to-use login directly inside an
-- existing organization. Provisioning instructions travel in app_metadata,
-- which can only be written by the service-role Auth Admin API. Regular
-- sign-ups keep the original behavior and receive their own organization.
