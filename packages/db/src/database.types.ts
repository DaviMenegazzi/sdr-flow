  ...
  public: {
    ...
    billing_entitlement_changes: {
      Row: {
        id: string;
        organization_id: string;
        previous_tier: Database['public']['Enums']['org_tier'];
        new_tier: Database['public']['Enums']['org_tier'];
        reason: Database['public']['Enums']['entitlement_change_reason'];
        source: string;
    ...
    organization_subscriptions: {
      Row: {
        ...
        scheduled_offer_code: string | null;
        scheduled_offer_version: number | null;
        scheduled_tier: Database['public']['Enums']['org_tier'] | null;
    ...
    Enums: {
      ...
      billing_payment_status: "pending" | "confirmed" | "received" | "overdue" | "refunded" | "chargeback" | "canceled";
      checkout_intent_status: "open" | "paid" | "expired" | "canceled" | "failed";
      ...
      entitlement_change_reason: "payment" | "renewal" | "upgrade" | "downgrade" | "grace_expired" | "period_ended" | "refund" | "chargeback" | "manual_grant" | "manual_revoke" | "grant_expired";
      member_role: "owner" | "admin" | "agent" | "viewer";
      org_tier: "pre-venda" | "vendedor" | "vendedor-senior";
      subscription_status: "pending_payment" | "active" | "past_due" | "suspended" | "canceled" | "expired";
    };
