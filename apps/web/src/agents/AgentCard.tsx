      ...
      <div>
        <div className="flex items-start justify-between gap-3 mb-3">
          <div className="flex items-center gap-2.5 min-w-0">
            <div className="w-9 h-9 rounded-xl bg-brand/10 border border-brand/20 flex items-center justify-center text-brand-fg flex-shrink-0 group-hover:scale-105 transition-transform">
            ...
            <div className="min-w-0">
              ...
              <p className="text-2xs font-mono text-content-muted mt-0.5 truncate">
        ...
        <div className="mb-3.5 pt-2.5 border-t border-border/50">
          <div className="flex items-center gap-1.5 text-2xs text-content-secondary mb-1">
          ...
          {assignedInstances.length > 0 ? (
            <div className="flex flex-wrap gap-1.5 mt-1">
              {assignedInstances.map((inst) => (
                <span
                  key={inst.id}
                  className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-2xs font-medium bg-surface-elevated border border-border text-content"
                >
                  <span
            ...
            <span className="text-2xs text-content-muted italic">
        ...
        {agent.system_prompt ? (
          <div className="p-2.5 rounded-lg bg-surface-elevated/40 border border-border/40 mb-4">
            <p className="text-2xs text-content-muted line-clamp-2 leading-relaxed italic">
              "{agent.system_prompt}"
            </p>
          </div>
        ) : (
