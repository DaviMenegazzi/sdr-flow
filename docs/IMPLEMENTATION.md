...
2. **Suíte de Testes Automatizados**:
   - A suíte possui **296 testes em 24 arquivos**. Em 09/09/2026, os 5 testes do debug do Inbox/WebSocket passaram; a execução completa ficou em 287/296 por nove divergências preexistentes entre testes e comportamento atual (`api-auth`, health legado, modo teste e política de ciclos do validador).
